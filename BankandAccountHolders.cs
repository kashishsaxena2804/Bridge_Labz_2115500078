...
class BankAccountHolders
{
    ...
    public BankAccountHolders(int accountNumber, double initialDeposit)
    {
...
class Customer
{
    ...
    private List<BankAccountHolders> accounts = new List<BankAccountHolders>();
    ...
    public void AddAccount(BankAccountHolders account)
    {
...
class Bank
{
    ...
    {
        BankAccountHolders account = new BankAccountHolders(accountCounter++, initialDeposit);  // Create new account
