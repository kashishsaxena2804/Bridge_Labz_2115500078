...
abstract class ProductD
{
    ...
    //Constructor
    public ProductD(string name, double price)
    {
        Name = name;
        Price = price;
    }
...
class ClothingCategory : ProductD
{
...
class ProductList<T> where T : ProductD
{
    ...
    public void ApplyDiscount<TProduct>(TProduct product, double discount) where TProduct : ProductD
    {
